...
<body onload="init()">
	...
	<header class="bg-grey py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-start text-white">
				<h1 class="display-4 fw-bolder">회원수정</h1>
			</div>
		</div>
	</header>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			action="processUpdatebMember.jsp" method="post"
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="submit" class="btn btn-outline-info" value="회원수정 "> 
					<a href="deletebMember.jsp" class="btn btn-outline-info">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
